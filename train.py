...
def train ():
    ...
    dataset = DataSet(datadir='/home/jiba/ConditionalDDPM/Mouse_Brain_Single_cell_Fullgene_dataset.pickle', transform=transform)
    ...
    for ep in range(EPOCHS):
        ...
        for images, genes, types in pbar:
            ...
            # print(f"loss:{loss}, l_rec:{l_rec}, l_gmm:{l_gmm}, l_diff:{l_diff}")
